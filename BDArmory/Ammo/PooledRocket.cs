...
namespace BDArmory.Bullets
{
    public class PooledRocket : MonoBehaviour
    {
        ...
        public void BeehiveDetonation()
        {
            ...
            float atmosphereDensity = (float)FlightGlobals.getAtmDensity(FlightGlobals.getStaticPressure(currentPosition), FlightGlobals.getExternalTemperature(currentPosition));
