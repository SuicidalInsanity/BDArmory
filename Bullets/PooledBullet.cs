...
namespace BDArmory.Bullets
{
	public class PooledBullet : MonoBehaviour
	{
		...
		private float CalculatePenetration()
		{
			...
			if (apBulletMod < 2)
			{
				apBulletMod = ((apBulletMod / 10) + 1); //prevent stock defs w/ apBulletMod = 20 from being hyperpenetrating, though this does mean that for 2x penetration would need a apBulletMod val of 10, 3x, 20, etc
			}
