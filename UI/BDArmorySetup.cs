...
namespace BDArmory.UI
{
    ...
    public class BDArmorySetup : MonoBehaviour
    {
        ...
        void WindowBDAToolbar(int windowID)
        {
            ...
            // Version.
            GUI.Label(new Rect(toolWindowWidth - 30 - 28 - 70, 23, 70, 10), Version + " S.I.", waterMarkStyle);
            ...
            if (ActiveWeaponManager != null)
            {
                ...
                {
                    if (ActiveWeaponManager.selectedWeapon.GetWeaponClass() == WeaponClasses.Gun || ActiveWeaponManager.selectedWeapon.GetWeaponClass() == WeaponClasses.Rocket)
                    {
