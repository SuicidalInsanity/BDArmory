...
namespace BDArmory.FX
{
    public class BulletHitFX : MonoBehaviour
    {
		...
		public static ObjectPool decalPool_exp1;
		public static ObjectPool decalPool_exp2;
        ...
        public static void SetupShellPool()
        {
			...
			GameObject templateShell_exp1;
			templateShell_exp1 =
				Instantiate(GameDatabase.Instance.GetModel("BDArmory/Models/bulletDecal/BulletDecal6"));
			templateShell_exp1.SetActive(false);
			if (decalPool_exp1 == null)
				decalPool_exp1 = ObjectPool.CreateObjectPool(templateShell_exp1, BDArmorySettings.MAX_NUM_BULLET_DECALS, true, true);

			GameObject templateShell_exp2;
			templateShell_exp2 =
				Instantiate(GameDatabase.Instance.GetModel("BDArmory/Models/bulletDecal/BulletDecal7"));
			templateShell_exp2.SetActive(false);
			if (decalPool_exp2 == null)
				decalPool_exp2 = ObjectPool.CreateObjectPool(templateShell_exp2, BDArmorySettings.MAX_NUM_BULLET_DECALS, true, true);
		}
